...
export function AppDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent
        className={`max-h-[85vh] w-[95vw] max-w-lg rounded-2xl border-2 border-ink bg-paper p-0 shadow-[8px_8px_0_var(--color-ink)] sm:rounded-2xl overflow-y-auto hide-scrollbar ${className}`}
      >
